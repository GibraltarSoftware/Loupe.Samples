(function ($) {
    ...
    function getSessions() {
        ...
        const settings = callSettings(`Customers/${currentTenant}/api/sessions`, false, 'POST');
        const data = {
            filters: [
                {
                    column: "Timestamp", grouping: 0, operator: 6, value1: "2022-10-10T00:00:00+01:00", value2: "2022-11-09T23:59:59+01:00"
                }
            ],
            paging: {
                skip: 0,
            ...
            sort: [{column: "EndedOn", direction: 1}]
        };
    ...
    function getLog(sessionId) {
        const settings = callSettings(`Customers/${currentTenant}/api/sessions/${sessionId}/log`, false, 'POST');
        settings.contentType = "application/json";
        settings.dataType = "json";
        const data = {
            id: sessionId,
    ...
    function searchLogs() {
        ...
        const settings = callSettings(`Customers/${currentTenant}/api/sessions/${selectedSession.id}/log`, false, 'POST');
        settings.contentType = "application/json";
        settings.dataType = "json";
        const data = {
